        ...
        <div class="row pt-3 justify-content-center">
           <div class="card col-md-12">
               ...
               <form action="Doctor_Update.php" method="POST" enctype="multipart/form-data" class="form">
                ...
                <input type="text" name="txtDegree" class="form-control" value="<?php echo $row['DocDegree'] ?>" id="DocDegree" required readonly>
                </div>

                <div class="form-group col-md-6">
                <label for="specialty">Specialty</label>
                <select id="specialty" class="form-control" name="cboSpecialty" required readonly>
                ...
                <?php 
                    ...
                    ?>
                    <option><?php echo $specialtyName ?></option>
            ...
            <div class="form-row">
                ...
                <select class="form-control" id="gender" name="cbogender" required readonly>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control" id="status" name="cbostatus" required readonly>
            ...
            <div class="form-row">
                ...
                <div class="input-group">
                    <input type="text" name="txtFees" class="form-control" value="<?php echo $row['ConsultationFees'] ?>" id="fees" required readonly/> 
                ...
                <div class="input-group">
                    <input type="text" name="txtClinicFees" class="form-control" value="<?php echo $row['ClinicFees'] ?>" id="clinicFees" required readonly/> 
                    <div class="input-group-append">
                        <span class="input-group-text">MMK</span>
                    </div>
                </div>
                ...
                <label for="ConsultTime">Average Consultation time</label>
                    <div class="input-group">
                        ...
                        id="ConsultTime" required readonly/>
                        <div class="input-group-append">
                ...
                <button type="submit" class="btn btn-primary mt-3 justify-content-center" name="btnUpdate">Update</button>
                <a href="DoctorDashboard.php" class="btn btn-secondary me-auto mt-3">Cancel</a>
